#ifndef _ShaderColorLightTextureTransparent
#define _ShaderColorLightTextureTransparent
...
class ShaderColorLightTextureTransparent : public ShaderBase
{
public:
	ShaderColorLightTextureTransparent(const ShaderColorLightTextureTransparent&) = delete;
	ShaderColorLightTextureTransparent(ShaderColorLightTextureTransparent&&) = default;
	ShaderColorLightTextureTransparent& operator=(const ShaderColorLightTextureTransparent&) & = default;
	...
	void SendAlphaData(float alpha);
