#include "ShaderColorLightTextureTransparent.h"
#include "../d3dUtil.h"
#include "../GraphicsBackend.h"
#include <d3d11.h>
#include <assert.h>

ShaderColorLightTextureTransparent::ShaderColorLightTextureTransparent(const std::string& filename)
	: ShaderBase(filename)
{
...
ShaderColorLightTextureTransparent::~ShaderColorLightTextureTransparent()
{
...
void ShaderColorLightTextureTransparent::SendFogData(const float& fogMin, const float& fogMax, const Vect& fogCol)
{
	FogData fogData;
...
void ShaderColorLightTextureTransparent::SendCamMatrices(const Matrix& view, const Matrix& proj)
{
...
void ShaderColorLightTextureTransparent::SetDirectionalLightParameters(const Vect& dir, const Vect& amb, const Vect& dif, const Vect& sp)
{
...
void ShaderColorLightTextureTransparent::SetPointLightParameters1(const Vect& pos, float r, const Vect& att, const Vect& amb, const Vect& dif, const Vect& sp)
{
...
void ShaderColorLightTextureTransparent::SetPointLightParameters2(const Vect& pos, float r, const Vect& att, const Vect& amb, const Vect& dif, const Vect& sp)
{
...
void ShaderColorLightTextureTransparent::SetPointLightParameters3(const Vect& pos, float r, const Vect& att, const Vect& amb, const Vect& dif, const Vect& sp)
{
...
void ShaderColorLightTextureTransparent::SetSpotLightParameters(const Vect& pos, float r, const Vect& att, const Vect& dir, float spotExp, const Vect& amb, const Vect& dif, const Vect& sp)
{
...
void ShaderColorLightTextureTransparent::SendLightParameters(const Vect& eyepos)
{
	Data_LightParams dl;
...
void ShaderColorLightTextureTransparent::SendWorldAndMaterial(const Matrix& world, const Vect& amb, const Vect& dif, const Vect& sp)
{
...
void ShaderColorLightTextureTransparent::SendAlphaData(float alpha)
{
	AlphaData ad;
	ad.alpha = alpha;
